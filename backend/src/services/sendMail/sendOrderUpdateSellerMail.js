...
export async function sendOrderUpdateSellerMail({
  ...
  try {
    const payload = {
      ...
      to: [{ email, name }],
      subject: `📦 Order Updated | ${APP_NAME} (Seller)`,
      htmlContent: `
<div style="font-family: Inter, Arial, sans-serif; background:#ffffff; padding:40px;">
  <div style="max-width:620px; margin:0 auto; color:#111827;">
    ...
    <p style="font-size:15px; line-height:1.7; color:#374151; margin-bottom:20px;">
      Hi ${name},<br/><br/>
      An order related to your products has been updated.
    </p>
    ...
    ">
      ...
      <p style="margin-top:12px; font-size:14px; color:#6b7280;">Status</p>
      <p style="margin:6px 0 0; font-size:16px; font-weight:600;">
        ${orderStatus}
      </p>
    ...
    <a
      href="${FRONTEND_URL}/product/orders/seller"
      style="
    ...
    <p style="font-size:13px; color:#6b7280; line-height:1.6;">
      This is an automated seller notification from <strong>${APP_NAME}</strong>.
    </p>
    ...
    console.log(`${APP_NAME} SELLER UPDATE EMAIL SENT:`, response.data.messageId)
